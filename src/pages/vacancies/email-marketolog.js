...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"vacancies/email-marketolog"} />
		<Helmet>
			<title>
				Email-маркетолог
			</title>
			<meta name={"description"} content={"Ищем Middle Email-маркетолога, готового взять на себя всю ответственность по обеспечению внутренних рассылок и push-уведомлений проектов uKit и uCoz.\n\n"} />
			<meta property={"og:title"} content={"Email-маркетолог"} />
			<meta property={"og:description"} content={"Ищем Middle Email-маркетолога, готового взять на себя всю ответственность по обеспечению внутренних рассылок и push-уведомлений проектов uKit и uCoz.\n\n"} />
			...
			<Stack margin="0px 0px 0px 0px" max-width="850px">
				...
				<StackItem display="flex" width="100%">
					...
					>
						...
						<br />
						<br />
						Вакансия будет интересна тем, кто хочет развиваться в область продуктового маркетинга, потому что прямо сейчас наша команда занимается разработкой ESP-системы RuSender.ru{"\n\n"}
					</Text>
					<Text
						letter-spacing=".2"
