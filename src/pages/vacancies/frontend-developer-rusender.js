...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"vacancies/frontend-developer-rusender"} />
		<Helmet>
			<title>
...
Ростов-на-Дону, Баку и Удаленная работа{"\n\n"}
					...
					>
						...
						<br />
						Проект новый, релиз состоялся в августе 2023.
						<br />
						Стек проекта: Vue.js, Nuxt.js, Nest.js, PostgreSQL, RabbitMQ, Docker, TypeScript.
						<br />
						Методология: Scrum.
						<br />
						Команда: 12 человек
					...
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Опыт работы и понимание JavaScript и HTML;{"\n\n"}
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Практический опыт работы с HTML, Vue.js, Nuxt.js от 1-го года;
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
