...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"vacancies/frontend-razrabotchik"} />
		<Helmet>
			<title>
...
Ростов-на-Дону, Баку и Удаленная работа{"\n\n"}
					...
					>
						uKit Group (uCoz, uKit, RuSender, WebAsk) – это аккредитованная IT-компания с более чем 18-летним опытом создания SaaS-сервисов, которыми пользуются миллионы людей по всему миру.
						<br />
						<br />
						Одна из наших продуктовых команд приглашает опытного Frontend-разработчика для работы над высоконагруженными проектами.
						<br />
						<br />
						Мы ищем специалиста с глубокими знаниями Vue.js и опытом работы с современными фронтенд-технологиями.{"\n\n"}
					</Text>
					<Text
						sm-margin="10px 0px 20px 0px"
						text-align="left"
					...
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Разработка нового функционала в команде
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Разработка фронтенда для многопользовательских веб-сервисов
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Разработка фронтенда для Telegram-ботов и мобильных приложений
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Участие в разработке и масштабировании онлайн-игры для Telegram, работа с памятью и нагрузкой
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Поддержка и оптимизация существующих сервисов, обеспечение их стабильной работы под высокой нагрузкой
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
					...
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Опыт работы: от 2-х лет в коммерческой Frontend-разработки с использованием Vue.js 3 версии
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Уверенные знания и опыт работы с JavaScript
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Уверенные знания и опыт работы с HTML и CSS, знание TailwindCSS
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Разработка анимаций
						</Text>
						...
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Понимание современных стандартов и практик веб-разработки
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
					...
					>
						...
						/>
						<Text margin="3px 0px 3px 0px" font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif">
							График 5/2 в офисе, гибридный или полностью удаленный формат работы;
						</Text>
					</Box>
					<Box
						display="flex"
					...
					>
						...
						/>
						<Text margin="3px 0px 3px 0px" font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif">
							Современная рабочая техника для сотрудников офиса.
						</Text>
					</Box>
					<Text
						sm-margin="10px 0px 20px 0px"
