...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"vacancies/fullstack-react-laravel"} />
		<Helmet>
			<title>
				Fullstack разработчик (React/Laravel)
			</title>
			<meta name={"description"} content={"uKit Group в поиске fullstack разработчика для участия в работе над интересным и сложным проектом WebAsk (https://webask.io).\n\n"} />
			<meta property={"og:title"} content={"Fullstack разработчик (React/Laravel)"} />
			<meta property={"og:description"} content={"uKit Group в поиске fullstack разработчика для участия в работе над интересным и сложным проектом WebAsk (https://webask.io).\n\n"} />
...
Ростов-на-Дону, Баку
					...
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							PostgreSQL 12 (использование триггеров, хранимых процедур, генерируемых колонок);
						</Text>
					</List>
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Redis (используется для очередей, фоновых задач, сессий).
						</Text>
					</List>
					<Text
						letter-spacing=".2"
					...
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Отличное знание JavaScript (не должны приводить в ужас вопросы про замыкания, анонимные функции, каррирование);
						</Text>
					</List>
					<List padding="0px 0px 0px 20px" margin="0px 0px 0px 0px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
					...
					<List padding="0px 0px 0px 20px" margin="0px 0px 0px 0px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Практический опыт работы с React/Redux от 2-х лет.
						</Text>
					</List>
					<Text
						letter-spacing=".2"
					...
					<List padding="0px 0px 0px 20px" margin="0px 0px 0px 0px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Понимание Laravel и базовых паттернов ООП;
						</Text>
					</List>
					<List padding="0px 0px 0px 20px" margin="0px 0px 0px 0px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Свободное написание оптимальных запросов на SQL;
						</Text>
					</List>
					<List padding="0px 0px 0px 20px" margin="0px 0px 0px 0px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
