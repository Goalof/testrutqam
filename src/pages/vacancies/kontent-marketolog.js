...
import { Theme, Icon, Link, Strong, Text, List, Image, Box, Section } from "@quarkly/widgets";
...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"vacancies/kontent-marketolog"} />
		<Helmet>
			<title>
				Контент-маркетолог
			</title>
			<meta name={"description"} content={"uKit Group — это аккредитованная IT-компания, которая специализируется на создании SaaS-сервисов и более 18-ти лет создает онлайн-продукты, у которых миллионы пользователей.\n\nНаши наиболее известные продукты — это uCoz, uKit, WebAsk, uCalc, RuSender.\n\nИщем контент-маркетолога в команду (middle+ или выше)."} />
			<meta property={"og:title"} content={"Контент-маркетолог"} />
			<meta property={"og:description"} content={"uKit Group — это аккредитованная IT-компания, которая специализируется на создании SaaS-сервисов и более 18-ти лет создает онлайн-продукты, у которых миллионы пользователей.\n\nНаши наиболее известные продукты — это uCoz, uKit, WebAsk, uCalc, RuSender.\n\nИщем контент-маркетолога в команду (middle+ или выше)."} />
...
Ростов-на-Дону, Баку и Удаленная работа{"\n\n"}
					...
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Разрабатывать и внедрять эффективную контент-стратегию для продвижения продуктов компании;
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Обеспечивать полный цикл работы с контентом — от идеи до отчетности;
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Организовывать весь процесс создания контента, контролировать реализацию;
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Работать с самыми разными контент-форматами — от новостей до видеороликов;
							<br />
							{"\n\n"}
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Разрабатывать темы для статей, собирать референсы и выпускать готовые материалы;
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Формировать контент-план исходя из задач компании;
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Подбирать площадки и размещать на них контент;
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Готовить отчеты по результатам работы и предлагать улучшения;
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Следить за рынком, искать новые интересные форматы и темы.
						</Text>
					</List>
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px" />
					<Text
					...
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Релевантный опыт работы контент-маркетологом в IT от 2-х лет;
							<br />
							{"\n\n"}
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Умение работать с метриками и анализировать их;
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Умение работать с разными каналами для продвижения контента;
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Умение анализировать целевую аудиторию;
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Опыт создания текстов, наличие примеров статей, публикаций;
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Навыки анализа данных и умение принимать решения на основе данных;
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
					...
					<Text
						...
						display="inline-block"
					>
						Отправьте нам свое портфолио и в сопроводительном письме напишите пару слов о себе.
						<Strong />
						<br />
						{"\n\n"}
					</Text>
					...
					>
						...
						<Text margin="3px 0px 3px 0px" font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif">
							Работа в аккредитованной продуктовой IT-компании;
						</Text>
					</Box>
					<Box
						align-items="center"
					...
					>
						...
						/>
						<Text margin="3px 0px 3px 0px" font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif">
							Высокая заработная плата (зависит от опыта), бонусы за успехи на проекте;
						</Text>
					</Box>
					<Box
						display="flex"
					...
					>
						...
						/>
						<Text margin="3px 0px 3px 0px" font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif">
							Профессиональный рост, работа в сильной команде;
						</Text>
					</Box>
					<Box
						display="flex"
					...
					>
						...
						/>
						<Text margin="3px 0px 3px 0px" font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif">
							Или гибридный или офисный формат работы для тех, кто находится в Ростове-на-Дону, в Баку;
						</Text>
					</Box>
					<Box
						display="flex"
