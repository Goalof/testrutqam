...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"vacancies/middle-backend-developer"} />
		<Helmet>
			<title>
				Middle Backend-разработчик
			</title>
			<meta name={"description"} content={"Продуктовая IT компания uKit Group рада принять в свои ряды Middle Backend-разработчика.\n\nЗадачи:\n\nКомандная разработка нашего нового продукта RuSender.\n\nRuSender.ru - это умный сервис для email-рассылок (ESP).\n\nСтек: NestJS, PostgreSQL, Redis, RabbitMQ."} />
			<meta property={"og:title"} content={"Middle Backend-разработчик"} />
			<meta property={"og:description"} content={"Продуктовая IT компания uKit Group рада принять в свои ряды Middle Backend-разработчика.\n\nЗадачи:\n\nКомандная разработка нашего нового продукта RuSender.\n\nRuSender.ru - это умный сервис для email-рассылок (ESP).\n\nСтек: NestJS, PostgreSQL, Redis, RabbitMQ."} />
			...
			<Stack margin="0px 0px 0px 0px" max-width="850px">
				...
				<StackItem display="flex" width="100%">
					...
					<List padding="0px 0px 0px 20px" margin="0px 0px 0px 0px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Практический опыт работы с Node.JS от 2-х лет;
						</Text>
					</List>
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Практический опыт работы с Nest.JS;
						</Text>
					</List>
					<List padding="0px 0px 0px 20px" margin="0px 0px 0px 0px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
