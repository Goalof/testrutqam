...
import { Theme, Icon, Link, Text, Strong, List, Image, Box, Span, Section } from "@quarkly/widgets";
...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"vacancies/middle-fullstack"} />
		<Helmet>
			<title>
				Middle Fullstack-разработчик
			</title>
			<meta name={"description"} content={"uKit Group рада принять в свои ряды Middle Fullstack-разработчика в офис города Ростов-на-Дону.  \nБольше года мы работали над новым проектом и успешно его запустили.\nRuSender.ru - это умная система для email-рассылок\n"} />
			<meta property={"og:title"} content={"Middle Fullstack-разработчик"} />
			<meta property={"og:description"} content={"uKit Group рада принять в свои ряды Middle Fullstack-разработчика в офис города Ростов-на-Дону.  \nБольше года мы работали над новым проектом и успешно его запустили.\nRuSender.ru - это умная система для email-рассылок\n"} />
...
Ростов-на-Дону, Баку
					...
					<Text
						...
						color="#333"
					>
						uKit Group рада принять в свои ряды Middle Fullstack-разработчика в офис или на удаленку.{"  "}
						<br />
						Больше года мы работали над новым проектом и успешно его запустили.
						<br />
						RuSender.ru - это умная система для email-рассылок
