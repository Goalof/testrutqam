...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"vacancies/seo-specialist-rostov"} />
		<Helmet>
			<title>
				SEO-специалист в Ростове-на-Дону
			</title>
			<meta name={"description"} content={"Мы ищем SEO специалиста в Ростове-на-Дону"} />
			...
			<Stack margin="0px 0px 0px 0px" max-width="850px">
				...
				<StackItem width="100%" display="flex">
					...
					>
						...
						/>
						<Text margin="6px 0px 6px 0px" font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif">
							корпоративное питание с поваром в офисе;
						</Text>
					</Box>
					<Box
						display="flex"
