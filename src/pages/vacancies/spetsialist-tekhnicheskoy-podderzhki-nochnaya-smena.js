...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"vacancies/spetsialist-tekhnicheskoy-podderzhki-nochnaya-smena"} />
		<Helmet>
			<title>
				Специалист технической поддержки (ночная смена, IT)
			</title>
			<meta name={"description"} content={"Сейчас мы ищем специалиста с опытом работы в IT-поддержке или с базовыми знаниями основ web."} />
			<meta property={"og:title"} content={"Специалист технической поддержки (ночная смена, IT)"} />
			<meta property={"og:description"} content={"Сейчас мы ищем специалиста с опытом работы в IT-поддержке или с базовыми знаниями основ web."} />
				...
				<StackItem width="100%" display="flex">
					...
					>
						...
						<Text margin="3px 0px 3px 0px" font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif">
							График работы 5/2 с 22:00 до 7:00 по МСК.
						</Text>
					</Box>
					<Box
						display="flex"
					...
					>
						...
						/>
						<Text margin="3px 0px 3px 0px" font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif">
							На период обучения: 5/2 с 10:00 до 19:00 по МСК (возможны варианты).
						</Text>
					</Box>
					<Box
						display="flex"
					...
					>
						...
						/>
						<Text margin="3px 0px 3px 0px" font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif">
							Офисный или гибридный формат: у нас есть уютный офис в Ростове-на-Дону с собственной парковкой и вкусным питанием
						</Text>
					</Box>
					<Box
						display="flex"
					...
					>
						...
						/>
						<Text margin="3px 0px 3px 0px" font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif">
							Работу в аккредитованной IT компании, которая уже 19 лет создает успешные онлайн-продукты: uCoz, uKit, WebAsk, uCalc, RuSender.
						</Text>
					</Box>
					<Box
						display="flex"
