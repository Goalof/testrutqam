...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"vacancies/team-lead-sre"} />
		<Helmet>
			<title>
				Team Lead (SRE)
			</title>
			...
			<meta property={"og:title"} content={"Team Lead (SRE)"} />
...
видеть тебя в рядах uKit Group!
						<br />
						<br />
						{"\n"}Основной стек c которым предстоит работать:
Nginx, Traefik, PM2, Node.js, NestJs, PHP, PostgreSQL, MongoDB, Redis, RabbitMQ,
Docker, GitLab, Elasticsearch, Kibana, Grafana, Zabbix, Ansible.{"\n\n\n\n\n\n\n"}
					</Text>
					<Text
						letter-spacing=".2"
					...
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Постановка и контроль задач системным администраторам отдела, помощь
CTO в операционных задачах;{"\n\n"}
						</Text>
					</List>
					<List padding="0px 0px 0px 20px" margin="0px 0px 0px 0px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Взаимодействие с СТО и командой разработчиков для своевременного
решения проектных задач;{"\n\n"}
					...
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Написание документации, работа по стандартизации процессов отдела;
						</Text>
					</List>
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Администрирование нагруженных серверов на Linux (Debian-based);{"\n\n"}
						</Text>
					</List>
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Администрирование Nginx, Traefik, PostgreSQL, MongoDB, RabbitMQ, Docker,
GitLab, Elasticsearch, Kibana, Grafana, Zabbix;{"\n\n"}
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Настройка и поддержка кластеризаций СУБД, брокеров сообщений;{"\n\n\n"}
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Тюнинг производительности;{"\n\n"}
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Обеспечение и аудит безопасности;{"\n\n"}
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Мониторинг работы систем;{"\n\n\n"}
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Восстановление сервисов и систем после сбоя.
						</Text>
					</List>
					<Text
						letter-spacing=".2"
					...
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Умение грамотно выстроить коммуникацию и взаимодействие с другими
отделами;{"\n\n\n"}
						</Text>
					</List>
					<List padding="0px 0px 0px 20px" margin="0px 0px 0px 0px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Понимание принципов разработки web-приложений;{"\n\n"}
						</Text>
					</List>
					<List padding="0px 0px 0px 20px" margin="0px 0px 0px 0px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Опыт руководства командой, постановки и контроля задач;{"\n\n"}
						</Text>
					</List>
					<List padding="0px 0px 0px 20px" margin="0px 0px 0px 0px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Продвинутый опыт работы с Docker;{"\n\n"}
						</Text>
					</List>
					<List padding="0px 0px 0px 20px" margin="0px 0px 0px 0px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Продвинутый опыт работы с Gitlab, Gitlab CI, опыт настройки CI/CD;{"\n\n"}
						</Text>
					</List>
					<List padding="0px 0px 0px 20px" margin="0px 0px 0px 0px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
					...
					<List padding="0px 0px 0px 20px" margin="0px 0px 0px 0px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Понимание DNS-записей DKIM, SPF, DMARC.{"\n\n"}
						</Text>
					</List>
					<Text
						color="#333"
					...
					>
						...
						/>
						<Text margin="6px 0px 6px 0px" font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif">
							График 5/2 в офисе или гибридный формат работы, возможна полностью
удаленная работа;{"\n\n"}
						</Text>
					</Box>
					<Box
