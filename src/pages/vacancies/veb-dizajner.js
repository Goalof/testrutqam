...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"vacancies/veb-dizajner"} />
		<Helmet>
			<title>
				Quarkly export
			</title>
		...
		<Section padding="140px 0 60px 0" sm-padding="110px 0 40px 0" lg-padding="120px 0 80px 0">
			...
			<StackItem width="100%" display="flex">
				...
				>
					...
					проекта Quarkly (quarkly.io). Отличная возможность усилить свои навыки и выйти на новый уровень дизайна, будет обучение полному циклу создания сайтов и приложений, верстке, анимации и фронтенд-разработке (React.js)
					<br />
				...
				<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
					<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
						Дизайн и сборка сайтов на Quarkly;{"\n\n"}
					</Text>
				</List>
				<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
					<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
						Дизайн и сборка шаблонов и блоков для Quarkly;
					</Text>
				</List>
				<Text
					font="normal 400 20px/1.2 'AvenirNextCyrMedium', sans-serif"
...
;
				...
				<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
					<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
						Способность делать привлекательный, выразительный и современный web-дизайн;
					</Text>
				</List>
				<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
					<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
				...
				<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
					<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
						Ориентация в современных трендах веб-индустрии;{"\n\n"}
					</Text>
				</List>
				<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
					<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
				...
				>
					...
					/>
					<Text margin="3px 0px 3px 0px" font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif">
						Обучение полному циклу создания сайтов и приложений, основам верстки, фронтенд-разработки;
					</Text>
				</Box>
				<Box
					display="flex"
