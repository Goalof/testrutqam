...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"vacancies/veb-dizajner1"} />
		<Helmet>
			<title>
			...
			<Stack margin="0px 0px 0px 0px" max-width="850px">
				...
				<StackItem width="100%" display="flex">
					...
					<Text
						...
						color="#333"
					>
						В команду проекта uKit ищем веб-дизайнера.
					</Text>
					<Text
					...
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						...
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Опыт в создании лендингов;
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Умение следовать заданному стилю интерфейса.
						</Text>
					</List>
					<Text
						font="normal 400 20px/1.2 'AvenirNextCyrMedium', sans-serif"
					...
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px">
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Проектируете удобные веб-интерфейсы
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Имеете опыт создания дизайн-систем, гайдлайнов, UI-китов
						</Text>
						<Text font="normal 400 16px/28px 'AvenirNextCyrRegular', sans-serif" margin="0px 0px 12px 5px">
							Работаете с готовыми иллюстрациями в векторе и создаёте собственные
						</Text>
					</List>
					<List margin="0px 0px 0px 0px" padding="0px 0px 0px 20px" />
					<Text
